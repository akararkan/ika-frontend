                ...
                {rows.map(n => {
                  ...
                  return (
                    <div key={n.id} className={'ntf-row ' + (n.unread ? 'unread' : '')} style={{ cursor: n.deepLink ? 'pointer' : 'default', '--cat': tint }} onClick={() => open(n)}>
                      <div className="ntf-avatar" role={isTrending ? undefined : 'button'} onClick={goActor}>
                        {isTrending
                        ...
                        <span className="ntf-badge" style={{ background: tint }}><Icon name={isTrending ? 'trending' : (CAT_ICON[n.category] || 'bell')} className="xs"/></span>
                      </div>
                      <div className="ntf-body">
                        ...
                        <small className="ntf-meta">
                          ...
                          {n.aggregateCount > 1 && <span className="ntf-agg"><Icon name="follow" className="xs"/>{n.aggregateCount} people</span>}
                        </small>
                      </div>
