...
const META = {
  ...
  QNA_REANSWER_CREATED:['reply','#0e6b54'], QNA_ANSWER_REACTION:['heart','#c2453f'], QNA_BEST_ANSWER_VOTE:['check','#159a76'],
...
const FILTERS = [
  ...
  ['QNA', 'Q&A', ['QNA_QUESTION_CREATED','QNA_QUESTION_SAVED','QNA_ANSWER_CREATED','QNA_REANSWER_CREATED','QNA_ANSWER_REACTION','QNA_BEST_ANSWER_VOTE']],
