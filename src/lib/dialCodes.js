/* =========================================================
   Country calling codes — the picker data for phone inputs.

   [iso2, name, dial] — iso2 disambiguates shared dials (US/CA
   are both +1), names are English display names, dials carry
   no '+'. Sorted by name at module load; Iraq is the app's
   default and is looked up by iso2, not position.

   The picker exists for assembly ONLY — the server's
   PhoneNormalizer remains the authority on validity. Callers
   must follow the phone-verification guide: send dial+local
   OR a raw full number, never both glued together.
   ========================================================= */

const RAW = [
  ['AF', 'Afghanistan', '93'], ['AL', 'Albania', '355'], ['DZ', 'Algeria', '213'],
  ['AS', 'American Samoa', '1684'], ['AD', 'Andorra', '376'], ['AO', 'Angola', '244'],
  ['AI', 'Anguilla', '1264'], ['AG', 'Antigua & Barbuda', '1268'], ['AR', 'Argentina', '54'],
  ...
  ['BO', 'Bolivia', '591'], ['BA', 'Bosnia & Herzegovina', '387'], ['BW', 'Botswana', '267'],
  ['BR', 'Brazil', '55'], ['VG', 'British Virgin Islands', '1284'], ['BN', 'Brunei', '673'],
  ...
  ['NU', 'Niue', '683'], ['KP', 'North Korea', '850'], ['MK', 'North Macedonia', '389'],
  ...
  ['RW', 'Rwanda', '250'], ['WS', 'Samoa', '685'], ['SM', 'San Marino', '378'],
  ['ST', 'São Tomé & Príncipe', '239'], ['SA', 'Saudi Arabia', '966'], ['SN', 'Senegal', '221'],
  ...
  ['ES', 'Spain', '34'], ['LK', 'Sri Lanka', '94'], ['KN', 'St Kitts & Nevis', '1869'],
  ['LC', 'St Lucia', '1758'], ['VC', 'St Vincent & the Grenadines', '1784'], ['SD', 'Sudan', '249'],
  ...
  ['TC', 'Turks & Caicos', '1649'], ['TV', 'Tuvalu', '688'], ['UG', 'Uganda', '256'],
  ...
  ['VI', 'US Virgin Islands', '1340'], ['YE', 'Yemen', '967'], ['ZM', 'Zambia', '260'],
  ['ZW', 'Zimbabwe', '263'],
]
...
export const dialOf = (iso2) => COUNTRIES.find(c => c.iso2 === iso2)?.dial || ''

/** 'IQ' → 🇮🇶 — ISO2 letters mapped onto regional-indicator codepoints. */
